...
namespace YT.Trading.Migrations
{
    public partial class InitAllTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "QuoteServer_Currencies",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    CurCode = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    CurEnName = table.Column<string>(type: "longtext CHARACTER SET utf8mb4", nullable: true),
                    AnchorRate = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    AnchoringCurCode = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false),
                    AnchorRateFlush = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuoteServer_Currencies", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuoteServer_Currencies_CreationTime",
                table: "QuoteServer_Currencies",
                column: "CreationTime");

            migrationBuilder.CreateIndex(
                name: "IX_QuoteServer_Currencies_CurCode",
                table: "QuoteServer_Currencies",
                column: "CurCode",
                unique: true);
        }
