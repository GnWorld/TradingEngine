    ...
    public partial class InitAllTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuetoServer_Currencies", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuetoServer_Currencies_CreationTime",
                table: "QuetoServer_Currencies",
                column: "CreationTime");

            migrationBuilder.CreateIndex(
                name: "IX_QuetoServer_Currencies_CurCode",
                table: "QuetoServer_Currencies",
                column: "CurCode",
                unique: true);
        }
