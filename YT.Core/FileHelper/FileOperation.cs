...
namespace YT.Core.FileHelper
{
    public class FileOperation
    {
        ...
        /// </summary>
        /// <param name="filePath">文件的绝对路径</param>        
        public static string[] TryReadAllLines(string filePath)
        {
            try
            {
                //将文本文件的各行读到一个字符串数组中
        ...
        /// 向文本文件中写入内容,换行
        /// </summary>
        /// <param name="filePath">完整路径，含文件名</param>
        /// <param name="strInfo">写入的内容</param>
        /// <returns></returns>
        ...
        public static bool WriteLine(string filePath, string[] Contents)
        {
